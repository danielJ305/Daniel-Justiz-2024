...
export function AboutIntro() {
    ...
    return (
      <div
        ref={container2}
        className='flex flex-row flex-wrap justify-center w-full sm:mb-12 md:m-8 lg:m-12 lg:mt-0 md lg:mt-0 mt-32'
      >
        <div className='md:basis-1/2 m-2 lg:m-4 p-4 bg-[#0B192C]/50 rounded-md rounded-md w-full lg:p-12 flex flex-col justify-between h-[28rem] sm:h-[36rem] md:h-[36rem] lg:h-[38rem] grow lg:grow-0'>
          <div>
            <h1 className='text-[3rem] lg:text-[5.2rem] md:text-[4.2rem] leading-tight font-bold'>
          ...
          <div className='flex flex-row justify-between mt-6  w-full'>
            <div>
              <p className='text-2xl'>10 Years Graphic Design Experience</p>
            </div>
            <Link href='#contact'>
